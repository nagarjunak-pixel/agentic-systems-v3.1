...
phase5_dir = os.path.abspath(os.path.join(current_dir, "."))

for path in [current_dir, parent_dir, phase0_dir, phase1_dir, phase2_dir, phase3_dir, phase4_dir, phase5_dir]:
